...
namespace Data.Migrations
{
    ...
    [Migration("20250316113858_addedStockMetricsAndCryptoMetrics")]
    partial class addedStockMetricsAndCryptoMetrics
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Data.Models.FinanceData", b =>
                {
                    ...
                    b.Property<int?>("CryptoMetricsId")
                        .HasColumnType("int");

                    b.Property<Guid>("PublicId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int?>("StockMetricsId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("CryptoMetricsId");

                    b.HasIndex("StockMetricsId");
            ...
            modelBuilder.Entity("Data.Models.FinanceData", b =>
                {
                    b.HasOne("Data.Models.CryptoMetrics", "CryptoMetrics")
                        .WithMany()
                        .HasForeignKey("CryptoMetricsId");

                    b.HasOne("Data.Models.StockMetrics", "StockMetrics")
                        .WithMany()
                        .HasForeignKey("StockMetricsId");
